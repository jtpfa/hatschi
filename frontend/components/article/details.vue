<template>
    <div>
        ...
        <p>
            ...
            Vorschein zu bringen. Der Vorteil von HDR-Bildern gegenüber normalen Bildern ist eine gleichmäßige
            Helligkeit, starke Kontraste und intensive Farben. Hinweis: Bei IPS-Panels kann trotz Einhaltung höchster
            Standards produktionsbedingt Backlight-Bleeding auftreten. Infos dazu finden Sie hier:
            <b-link href="https://de.answers.acer/app/answers/detail/a_id/48244">
                de.answers.acer/app/answers/detail/a_id/48244
            </b-link>
        </p>
    </div>
</template>
