...
import OrderInvalidState from '~/components/order/steps/invalidState'
import OrderStep1 from '~/components/order/steps/step1/step1'
import OrderStep2 from '~/components/order/steps/step2/step2'
import OrderStep3 from '~/components/order/steps/step3/step3'

export default {
    name: 'OrderForm',
    components: { OrderStep3, OrderStep2, OrderStep1, CartSummary, OrderPagination, OrderHeadline, OrderInvalidState },
    data() {
        return {
            loading: false,
            error: '',
