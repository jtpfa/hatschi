...
/**
 * Unit-Test which tests mapping from CustomerEntity to CustomerDetailsDTO.
 *
 * @author Fynn Lohse
 */
...
class CustomerEntityCustomerDetailsDTOMapperUnitTest {
    ...
    class When {
        void aCustomerEntityIsMappedToDto(CustomerEntity customerEntity) {
            customerDetailsDTO = CustomerMapper.mapCustomerEntityToCustomerDetailsDto(customerEntity);
        }
    }
